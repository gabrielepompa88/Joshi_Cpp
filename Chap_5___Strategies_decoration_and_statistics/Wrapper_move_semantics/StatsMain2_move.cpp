...
#include "MCStatistics.h" // for StatisticsMean class
#include "ConvergenceTable2.h" // for ConvergenceTable class
#include "wrapper_move.h" // for Wrapper class
#include <iostream>
...
int main()
{
    ...
    // statistics gatherer
    // originally: StatisticsMean gathererCall;
    Wrapper<StatisticsMC> gathererCall{new StatisticsMean};
    ...
    // statistics gatherer
    // originally: StatisticsMean gathererCall2;
    Wrapper<StatisticsMC> gathererCall2{ std::move(gathererCall) }; // this calls the Wrapper move-constructor
